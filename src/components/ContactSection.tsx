...
const socials = [
  { label: 'EMAIL', value: 'atharvaphanse403@gmail.com', href: 'mailto:atharvaphanse403@gmail.com' },
  { label: 'PHONE', value: '+91 73870 89622', href: 'tel:+917387089622' },
  { label: 'LINKEDIN', value: 'atharva-phanse', href: 'https://linkedin.com/in/atharva-phanse-2aa4b62a5' },
  { label: 'GITHUB', value: 'Atharva45264', href: 'https://github.com/Atharva45264' },
];
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Have a role, project, or collaboration in mind? I'm currently open to work — reach out directly or send a message below.
              </p>
                ...
                {socials.map((s) => (
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{ fontFamily: "'Montserrat', sans-serif" }}
                    >
                      {s.value} <span className="text-[11.5px]">↗</span>
                    </span>
                  </a>
                ))}
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#EAE6DB] border border-[#4F7A63]/25 focus:border-[#2F6C4F] text-sm text-[#1C231D] placeholder-[#4F7A63]/60 px-4 py-3 outline-none rounded-sm transition-colors"
                      style={{ fontFamily: "'Montserrat', sans-serif" }}
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#EAE6DB] border border-[#4F7A63]/25 focus:border-[#2F6C4F] text-sm text-[#1C231D] placeholder-[#4F7A63]/60 p-4 outline-none rounded-sm transition-colors resize-none"
                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 border border-[#4F7A63]/40 bg-[#EAE6DB] hover:border-[#2F6C4F] hover:bg-[#2F6C4F] text-[#1C231D] hover:text-white text-sm font-medium tracking-[0.25em] uppercase transition-all duration-300 shadow-[0_4px_20px_rgba(90,78,62,0.08)]"
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
                  SEND MESSAGE ↗
                </button>

                <p className="text-[11px] text-[#4F7A63] text-center" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                  Note: connect this form to a service like Formspree or EmailJS to receive submissions.
                </p>
